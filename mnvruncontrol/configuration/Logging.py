...
try:
	...
	om_filehandler = logging.handlers.RotatingFileHandler(Configuration.params["log_OM"], maxBytes=204800, backupCount=5, delay=True)
	...
	readout_filehandler = logging.handlers.RotatingFileHandler(Configuration.params["log_readout"], maxBytes=204800, backupCount=5, delay=True)
	...
	mtest_filehandler = logging.handlers.RotatingFileHandler(Configuration.params["log_mtest"], maxBytes=204800, backupCount=5, delay=True)
	...
	daqmgr_filehandler = logging.handlers.RotatingFileHandler(Configuration.params["log_master"], maxBytes=204800, backupCount=5, delay=True)
...
#	PO_filehandler.setLevel(5)
	...
	frontend_filehandler = logging.handlers.RotatingFileHandler(Configuration.params["log_frontend"], maxBytes=204800, backupCount=5, delay=True)
