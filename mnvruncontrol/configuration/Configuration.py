...
configuration = {
	...
	"mstr_logfileLocation"        : ( Defaults.LOGFILE_LOCATION_DEFAULT,             "Master log file location",                            str   ),
	...
	"read_SCNumCrates"            : ( Defaults.SLOWCONTROL_NUM_CRATES_ATTACHED,      "How many crates are attached to this slow control?",  int   ),
