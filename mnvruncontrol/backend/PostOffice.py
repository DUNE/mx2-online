"""
  PostOffice.py:
   ...
   So it's best to think of this system like a newspaper or magazine
   distribution service, where articles are "published" and whoever
   subscribes can read them and send them along to anybody else --
   rather than like postal or e-mail, where recipients (and their
   physical/electronic "locations") are individually specified.
   If you get the wrong mindset, you'll probably wind up frustrated
   that it isn't working the way you expect :)
   
   One other (unrelated) note: the system is set up to use the
