...
if [ $HOSTNAME == "minervatest01.fnal.gov" ]; then
	...
	ln -s $HOME/mnvdaqrunscripts/minervatest_sngl_runcontrol.sh $HOME/runcontrol.sh
	ln -s $HOME/mnvdaqrunscripts/slowcontrol.sh $HOME/slowcontrol.sh
	ln -s $HOME/mnvdaqrunscripts/singledaqenv.sh $HOME/singledaqenv.sh
fi
...
if [ $HOSTNAME == "minervatest02.fnal.gov" ]; then
	...
	ln -s $HOME/mnvdaqrunscripts/minervatest_sngl_runcontrol.sh $HOME/sngl_runcontrol.sh
	ln -s $HOME/mnvdaqrunscripts/minervatest_mult_dispatcher.sh $HOME/dispatcher.sh
	ln -s $HOME/mnvdaqrunscripts/slowcontrol.sh $HOME/slowcontrol.sh
	ln -s $HOME/mnvdaqrunscripts/singledaqenv.sh $HOME/singledaqenv.sh
	ln -s $HOME/mnvdaqrunscripts/setupdaqenv.sh $HOME/multidaqenv.sh
fi
...
if [ $HOSTNAME == "minervatest03.fnal.gov" ]; then
	...
	ln -s $HOME/mnvdaqrunscripts/minervatest_mult_runcontrol.sh $HOME/runcontrol.sh
	ln -s $HOME/mnvdaqrunscripts/setupdaqenv.sh $HOME/multidaqenv.sh
fi
...
if [ $HOSTNAME == "mnvonline0.fnal.gov" ]; then
	...
	ln -s $HOME/mnvdaqrunscripts/mnvonline_mult_dispatcher.sh $HOME/dispatcher.sh
	ln -s $HOME/mnvdaqrunscripts/slowcontrol.sh $HOME/slowcontrol.sh
	ln -s $HOME/mnvdaqrunscripts/setupdaqenv.sh $HOME/multidaqenv.sh
fi
...
if [ $HOSTNAME == "mnvonlinemaster.fnal.gov" ]; then
	echo "Setting up multi-node scripts on ${HOSTNAME}..."
	ln -s $HOME/mnvdaqrunscripts/mnvonline_mult_runcontrol.sh $HOME/runcontrol.sh
	ln -s $HOME/mnvdaqrunscripts/setupdaqenv.sh $HOME/multidaqenv.sh
fi
