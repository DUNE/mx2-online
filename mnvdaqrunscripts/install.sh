...
if [ $HOSTNAME == "mnvtbonline0.fnal.gov" -o $HOSTNAME == "mnvtbonline1.fnal.gov" ]; then
	...
	ln -sf $HOME/mnvdaqrunscripts/singledaqenv.sh $HOME/daqenvironment.sh
...
if [ $HOSTNAME == "mnvtbonline2.fnal.gov" ]; then
	...
	ln -sf $HOME/mnvdaqrunscripts/check_daq_rc.sh $HOME/check_daq_rc.sh
	ln -sf $HOME/mnvdaqrunscripts/restart_all_minervatest.sh $HOME/hard_daq_restart.sh
...
if [ $HOSTNAME == "minervatest03.fnal.gov" ]; then
	...
	ln -sf $HOME/mnvdaqrunscripts/setupdaqenv.sh $HOME/setupdaqenv.sh
	ln -sf $HOME/mnvdaqrunscripts/check_daq_rc.sh $HOME/check_daq_rc.sh
	ln -sf $HOME/mnvdaqrunscripts/restart_all_minervatest.sh $HOME/hard_full_restart.sh
	ln -sf $HOME/mnvdaqrunscripts/restart_all_daq_rc_minervatest.sh $HOME/hard_daq_restart.sh
	ln -sf $HOME/mnvdaqrunscripts/dispatcher_minervatest_ssh.sh $HOME/dispatcher_restart.sh
fi
...
if [ $HOSTNAME == "minerva-rc.fnal.gov" ]; then
	...
	ln -sf $HOME/mnvdaqrunscripts/whcr_dispatcher_mnvonline.sh $HOME/dispatcher_restart.sh
...
if [ $HOSTNAME == "mnvonlinemaster.fnal.gov" -o $HOSTNAME == "mnvonlinebck1.fnal.gov" ]; then
	...
	ln -sf $HOME/mnvdaqrunscripts/dispatcher_multi.sh $HOME/restart_dispatcher.sh
fi
