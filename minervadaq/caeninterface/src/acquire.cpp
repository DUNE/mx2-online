...
int acquire::WriteFIFOBLT(int handle, int ml, unsigned char *send_message, unsigned int address, 
	CVAddressModifier AM, CVDataWidth DW) 
{
/*!
 * \fn int acquire::WriteFIFOBLT(int handle, int ml, unsigned char *send_message,  unsigned int address,
 *                          CVAddressModifier AM, CVDataWidth DW)
 *
