...
class BoardTest():
 def __init__(self, panel, caption=' CROCE Board Test',testcaptions=['RUN BOARD TEST','T1','T2','T3','T4','T5','T6','T7','T8','T9'],
        ...
        szH5.Add(szV1, 0, wx.ALL, 2)
        szH5.Add(szV2, 0, wx.ALL, 2)
        ...
        self.controls=[StaticBox,self.BoxSizer,self.btnRunBoardTest,lblNtimes,
            self.txtNtimes,self.chkTest1,self.chkTest2,self.chkTest3,self.chkTest4,
            self.chkTest5,self.chkTest6,self.chkTest7,self.chkTest8,self.chkTest9,
            ...
            self.txtREGTestData,self.chkWriteToFile]
...
class VMEReadWrite():
    def __init__(self, panel, caption=' VME Read/Write (hex)'):
        ...
        self.controls=[StaticBox,self.BoxSizer,lblAddr,lblData,self.btnRead,
            self.txtReadAddr,self.txtReadData,self.btnWrite,self.txtWriteAddr,
            self.txtWriteData,self.choiceAddressModifier,self.choiceDataWidth,
            self.txtBLTSize]
