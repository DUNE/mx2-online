...
class FEB():
    ...
    def BRAMReadDiscrim(self, theCROCXChannelX, theType):
        ...
        if theType=='CROC': return WriteSendReceive(sentMessage, 0, self.Address,
            Frame.DeviceBRAM, theCROCXChannelX, dw='D16', useBLT32=True)    
        if theType=='CROCE': return WriteSendReceiveCROCE(sentMessage, 0, self.Address,
            Frame.DeviceBRAM, theCROCXChannelX, dw='D32', useBLT32=True)
    def BRAMReadTrip(self, theCROCXChannelX, index, theType, theDataType23Hits):
        sentMessage = Frame().MakeHeader(Frame.DirectionM2S, Frame.BroadcastNone,
        ...
        #Comment 07.10.2013 for CROCE 23Hits compatibility with CROCE and CROC : LengthCROCE=LengthCROC+3
        if theType=='CROC':
            return WriteSendReceive(sentMessage, Frame.MessageDataLengthBRAMTripRead, self.Address,
                Frame.DeviceBRAM, theCROCXChannelX, dw='D16', useBLT32=True)    
        if theType=='CROCE':
            if theDataType23Hits==False:
                theMessageDataLengthBRAMTripRead=Frame.MessageDataLengthBRAMTripRead+1
            else:
                theMessageDataLengthBRAMTripRead=1+2*36*24+1+1 #(zero+data+zero+dummycrc)                
            return WriteSendReceiveCROCE(sentMessage, theMessageDataLengthBRAMTripRead, self.Address,
                Frame.DeviceBRAM, theCROCXChannelX, dw='D32', useBLT32=True)
    def BRAMReadHit(self, theCROCXChannelX, index, theType, theDataType23Hits):
        if index<=7:
            sentMessage = Frame().MakeHeader(Frame.DirectionM2S, Frame.BroadcastNone,
        ...
        if theType=='CROCE':
            if theDataType23Hits==False:
                theMessageDataLengthBRAMHitRead=Frame.MessageDataLengthBRAMHitRead+1
                theDeviceBRAM=Frame.DeviceBRAM
            else:
                theMessageDataLengthBRAMHitRead=Frame.MessageDataLengthBRAMHitRead+3
                if index<=7:
                    theDeviceBRAM=Frame.DeviceBRAM
                else:
                    theDeviceBRAM=Frame.DeviceBRAM2
            return WriteSendReceiveCROCE(sentMessage, theMessageDataLengthBRAMHitRead, self.Address,
                theDeviceBRAM, theCROCXChannelX, dw='D32', useBLT32=True)
    def FPGARead(self, theCROCXChannelX, theType='CROC', theDescription=''):
        ...
        if theType=='CROC': return WriteSendReceive(sentMessage, Frame.MessageDataLengthFPGA, self.Address,
            Frame.DeviceFPGA, theCROCXChannelX, dw='D16', useBLT32=True, theDescription=theDescription)
        if theType=='CROCE': return WriteSendReceiveCROCE(sentMessage, Frame.MessageDataLengthFPGA, self.Address,
            Frame.DeviceFPGA, theCROCXChannelX, dw='D32', useBLT32=True, theDescription=theDescription)
    def FPGADumpRead(self, theCROCXChannelX, theType='CROC'):
        sentMessage = Frame().MakeHeader(Frame.DirectionM2S, Frame.BroadcastNone, self.Address,
            Frame.DeviceFPGA, Frame.FuncFPGADumpRead)
        if theType=='CROC': return WriteSendReceive(sentMessage, Frame.MessageDataLengthFPGA, self.Address,
            Frame.DeviceFPGA, theCROCXChannelX, dw='D16', useBLT32=True)
        if theType=='CROCE': return WriteSendReceiveCROCE(sentMessage, Frame.MessageDataLengthFPGA, self.Address,
            Frame.DeviceFPGA, theCROCXChannelX, dw='D32', useBLT32=True)
    ...
    def TRIPProgramRST(self, theCROCXChannelX, theType='CROC'):
        ...
        if theType=='CROC': return WriteSendReceive(sentMessage, 9, self.Address,
            Frame.DeviceTRIP, theCROCXChannelX, dw='D16', useBLT32=False)
    ...
    def TRIPRead(self, theCROCXChannelX, theTRIPIndex=None, theType='CROC'):
        ...
        if theType=='CROC': return WriteSendReceive(sentMessage, Frame.MessageDataLengthTRIPRead, self.Address,
            Frame.DeviceTRIP, theCROCXChannelX, dw='D16', useBLT32=True)
        if theType=='CROCE': return WriteSendReceiveCROCE(sentMessage, Frame.MessageDataLengthTRIPRead, self.Address,
            Frame.DeviceTRIP, theCROCXChannelX, dw='D32', useBLT32=True)
    def TRIPWrite(self, theCROCXChannelX, theRegs, theTRIPIndex=None, theType='CROC'):
        ...
        if theType=='CROCE': WriteSendReceiveCROCE(sentMessage, Frame.MessageDataLengthTRIPWrite, self.Address,
            Frame.DeviceTRIP, theCROCXChannelX, dw='D32', useBLT32=True)
    def FLASHMainMemPageRead(self, theCROCXChannelX, pageAddr, theType='CROC', dw='D16', useBLT32=False):
        sentMessageHeader = Frame().MakeHeader(Frame.DirectionM2S, Frame.BroadcastNone, self.Address,
        ...
        if theType=='CROC': rcvMessageData,rcvMFH_10bytes=WriteSendReceive(sentMessage, Frame.MessageDataLengthFLASHMMPRead, 
            self.Address, Frame.DeviceFLASH, theCROCXChannelX, dw=dw, useBLT32=useBLT32)#use dw='D16',useBLT32=True
        if theType=='CROCE': rcvMessageData,rcvMFH_10bytes=WriteSendReceiveCROCE(sentMessage, Frame.MessageDataLengthFLASHMMPRead, 
            self.Address, Frame.DeviceFLASH, theCROCXChannelX, dw=dw, useBLT32=useBLT32)#use dw='D16',useBLT32=False
    ...
    def FLASHMainMemPageProgThroughBuffer(self, theCROCXChannelX, pageAddr, pageBytes, bufferIndex=1,
        theType='CROC', dw='D16', useBLT32=False):
        sentMessageHeader = Frame().MakeHeader(Frame.DirectionM2S, Frame.BroadcastNone, self.Address,
            Frame.DeviceFLASH, Frame.FuncFLASHCommand)
        ...
        if theType=='CROC':
            WriteSendReceive(sentMessage, Frame.MessageDataLengthFLASHMMPPTB, self.Address,
                Frame.DeviceFLASH, theCROCXChannelX, appendData=pageBytes[0], dw=dw, useBLT32=useBLT32)
        if theType=='CROCE':   
        ...
        if theType=='CROC':
            for i in range(100):
                rcvMessageData, rcvMFH_10bytes = WriteSendReceive(sentMessage, 9, self.Address,
                    Frame.DeviceFLASH, theCROCXChannelX, appendData=0, dw='D16', useBLT32=False)
    ...
    def WriteFileToFlash(self, theCROCXChannelX=None, theCROCX=None, theVMECROCXs=None, toThisFEB=False,
            toThisCHX=False, toThisCROCX=False, toAllCROCXs=False, theFrame=None, theType=None, dw='D16', useBLT32=False):
        ...
        if dlg.ShowModal()==wx.ID_OK:
            ...
            if toThisFEB:
                self.WritePagesToFlash(self, theCROCXChannelX, theCROCX, pagesAddrFile, pagesBytesFile,
                    theFrame, theType, dw=dw, useBLT32=useBLT32)     
            if toThisCHX:
    ...
    def WritePagesToFlash(self, theFEB, theCROCXChannelX, theCROCX, pagesAddrFile, pagesBytesFile,
        theFrame, theType, dw='D16', useBLT32=False):
        errPages=''
        ...
        for iPage in range(Flash.NPages):
            theFEB.FLASHMainMemPageProgThroughBuffer(theCROCXChannelX, pagesAddrFile[iPage], pagesBytesFile[iPage],
                bufferIndex=1, theType=theType, dw=dw, useBLT32=useBLT32)
            pageBytesRead=theFEB.FLASHMainMemPageRead(theCROCXChannelX, pagesAddrFile[iPage], theType, dw=dw, useBLT32=useBLT32)
    ...
    def ParseFPGARegsToMessage(sel, txtRegs):
        ...
        msg[27] = ((int(txtRegs[52].GetValue()) & 0x0F) << 0) + \
                  ((int(txtRegs[55].GetValue()) & 0x03) << 4)
        #message word 28 and 29-bits 3-0: WR InjDAC Value, 12 bits
...
def WriteSendReceiveCROCE(sentMessage, rcvMessageLength, theFEBAddress, theFEBDevice, theCROCEChannelE,
    ...
    if useBLT32: rcvMFH_10bytes,rcvMessageHeader,rcvMessageData=GetRcvMessageHeaderAndDataBLTCROCE(theCROCEChannelE,dw)
...
def GetRcvMessageHeaderAndDataBLT(theCROCChannel):
    ...
    return (rcvMessageHeader, rcvMessageData)
def GetRcvMessageHeaderAndDataBLTCROCE(theCROCEChannelE,dw='D32'):
