...
class SCMainFrame(wx.Frame):
	...
	self.menuFileReset          = menuFile.Append(wx.NewId(), "System &Reset", " V2718/VME System Reset")
        ...
        self.menuActionsSaveDescription     = menuActions.Append(wx.NewId(), "Sa&ve Current Description")
        ...
        menuActions.AppendSeparator()
        self.menuActionsAbout               = menuActions.Append(wx.NewId(), "&About")
        menuDebug = wx.Menu()
...
class VME(wx.Panel):
    ...
    def OnbtnShowAdvancedGUI(self, event):
        self.showAdvanced=SC_Util.ShowControls(self.btnShowAdvancedGUI, self.showAdvanced,
            self.VMEReadWrite.controls, self.BoardTest.controls)
        self.Fit()
...
class CHE(wx.Panel):
    def __init__(self, parent):
        ...
        self.CHEResets=SC_Util.CHEResets(self,
            captions=['Reset options','Reset this CHE','Reset this CROCE','Reset this CRATE','Reset all CRATES'])
        ...
        szH3.Add(self.SendMemory.BoxSizer, 1, wx.ALL|wx.EXPAND, 2)
        szH4=wx.BoxSizer(wx.HORIZONTAL)
        szH4.Add(self.ReceiveMemory.BoxSizer, 1, wx.ALL|wx.EXPAND, 2)
        szH5=wx.BoxSizer(wx.HORIZONTAL)
        szH5.Add(self.FramePointersMemory.BoxSizer, 1, wx.ALL|wx.EXPAND, 2)
        sizerALL=wx.BoxSizer(wx.VERTICAL)
        sizerALL.Add(szTop, 0, wx.ALL, 5)
    ...
    def OnbtnShowAdvancedGUI(self, event):
        self.showAdvanced=SC_Util.ShowControls(self.btnShowAdvancedGUI, self.showAdvanced,
            ...
            self.ReadAllRegisters.controls, self.HeaderDataRegister.controls, self.CHEResets.controls)
        self.Fit()
...
class DAQ(wx.Panel):
    def __init__(self, parent):
        ...
        self.chkDataTypeDiscrim23Hits=SC_Util.CreateCheckBox(self, label='23Hits', pos=(0,0), size=size, name='', bckcolor=SC_Util.colorButton)
