...
{
	if (argc < 2) {
		cout << "Usage : dataRunConfig -c <CROC Address> -h <CHANNEL Number> -f <Number of FEBs> ";
	...
	llConfig.info("--Starting dataRunConfig script.--");	
