...
class FEB():
    ...
    def FPGADescription(self, theCROCXChannelX, theCROCX, theType='CROC'):
        if theType=='CROC':
            return '%s:%d,%d,%d'%(SC_Util.VMEdevTypes.FPGA, self.Address, theCROCXChannelX.chNumber, theCROCX.baseAddr>>16)
        if theType=='CROCE':
            return '%s:%d,%d,%d'%(SC_Util.VMEdevTypes.FPGA, self.Address, theCROCXChannelX.cheNumber, theCROCX.baseAddr>>24)
    def TRIPDescription(self, theTripIndex, theCROCXChannelX, theCROCX, theType='CROC'):
        if theType=='CROC':
            return '%s:%s,%d,%d,%d'%(SC_Util.VMEdevTypes.TRIP, theTripIndex, self.Address, theCROCXChannelX.chNumber, theCROCX.baseAddr>>16)
        if theType=='CROCE':
            return '%s:%s,%d,%d,%d'%(SC_Util.VMEdevTypes.TRIP, theTripIndex, self.Address, theCROCXChannelX.cheNumber, theCROCX.baseAddr>>24)
    def FLASHDescription(self, thePageIndex, theCROCXChannelX, theCROCX, theType='CROC'):
        if theType=='CROC':
            return '%s:%s,%d,%d,%d'%(SC_Util.VMEdevTypes.FLASH, thePageIndex, self.Address, theCROCXChannelX.chNumber, theCROCX.baseAddr>>16)
        if theType=='CROCE':
            return '%s:%s,%d,%d,%d'%(SC_Util.VMEdevTypes.FLASH, thePageIndex, self.Address, theCROCXChannelX.cheNumber, theCROCX.baseAddr>>24)
    def BRAMReadDiscrim(self, theCROCXChannelX, theType):
        ...
        if theType=='CROC':
            return WriteSendReceive(sentMessage, 0, self.Address, Frame.DeviceBRAM, theCROCXChannelX, dw='D16', useBLT32=True)    
        if theType=='CROCE':
            return WriteSendReceiveCROCE(sentMessage, 0, self.Address, Frame.DeviceBRAM, theCROCXChannelX, dw='D16', useBLT32=True)
    def BRAMReadTrip(self, theCROCXChannelX, index, theType):
        sentMessage = Frame().MakeHeader(Frame.DirectionM2S, Frame.BroadcastNone,
            self.Address, Frame.DeviceBRAM, Frame.FuncBRAMReadTripx[index])
        if theType=='CROC':
            return WriteSendReceive(sentMessage, Frame.MessageDataLengthBRAMTripRead, self.Address, Frame.DeviceBRAM, theCROCXChannelX, dw='D16', useBLT32=True)    
        if theType=='CROCE':
            return WriteSendReceiveCROCE(sentMessage, Frame.MessageDataLengthBRAMTripRead+1, self.Address, Frame.DeviceBRAM, theCROCXChannelX, dw='D16', useBLT32=True)
    def BRAMReadHit(self, theCROCXChannelX, index, theType):
        sentMessage = Frame().MakeHeader(Frame.DirectionM2S, Frame.BroadcastNone,
            self.Address, Frame.DeviceBRAM, Frame.FuncBRAMReadHitx[index])
        if theType=='CROC':
            return WriteSendReceive(sentMessage, Frame.MessageDataLengthBRAMHitRead, self.Address, Frame.DeviceBRAM, theCROCXChannelX, dw='D16', useBLT32=True)    
        if theType=='CROCE':
            return WriteSendReceiveCROCE(sentMessage, Frame.MessageDataLengthBRAMHitRead+1, self.Address, Frame.DeviceBRAM, theCROCXChannelX, dw='D16', useBLT32=True)
    def FPGARead(self, theCROCXChannelX, theType='CROC'):
        ...
        if theType=='CROC':
            return WriteSendReceive(sentMessage, Frame.MessageDataLengthFPGA, self.Address, Frame.DeviceFPGA, theCROCXChannelX, dw='D16', useBLT32=True)    
        if theType=='CROCE':
            return WriteSendReceiveCROCE(sentMessage, Frame.MessageDataLengthFPGA, self.Address, Frame.DeviceFPGA, theCROCXChannelX, dw='D16', useBLT32=True)
    def FPGADumpRead(self, theCROCXChannelX, theType='CROC'):
        sentMessage = Frame().MakeHeader(Frame.DirectionM2S, Frame.BroadcastNone, self.Address,
        ...
        if theType=='CROCE':
            return WriteSendReceiveCROCE(sentMessage, Frame.MessageDataLengthFPGA, self.Address, Frame.DeviceFPGA, theCROCXChannelX, dw='D16', useBLT32=True)
    def FPGAWrite(self, theCROCXChannelX, sentMessageData, theType='CROC'):
        sentMessage = Frame().MakeHeader(Frame.DirectionM2S, Frame.BroadcastNone, self.Address,
        ...
        if theType=='CROCE':
            return WriteSendReceiveCROCE(sentMessage, Frame.MessageDataLengthFPGA, self.Address, Frame.DeviceFPGA, theCROCXChannelX, dw='D16', useBLT32=True)
    def TRIPProgramRST(self, theCROCXChannelX, theType='CROC'):
        sentMessage = Frame().MakeHeader(Frame.DirectionM2S, Frame.BroadcastNone, self.Address,
            Frame.DeviceTRIP, Frame.FuncTRIPWRAll) + [0,8,8,8,8,8,0,0]
        if theType=='CROC':
            return WriteSendReceive(sentMessage, 9, self.Address, Frame.DeviceTRIP, theCROCXChannelX)
        if theType=='CROCE':
            return WriteSendReceiveCROCE(sentMessage, 9, self.Address, Frame.DeviceTRIP, theCROCXChannelX) 
    def TRIPRead(self, theCROCXChannelX, theTRIPIndex=None, theType='CROC'):
        ...
        if theType=='CROC':
            return WriteSendReceive(sentMessage, Frame.MessageDataLengthTRIPRead, self.Address, Frame.DeviceTRIP, theCROCXChannelX, dw='D16', useBLT32=True)
        if theType=='CROCE':
            return WriteSendReceiveCROCE(sentMessage, Frame.MessageDataLengthTRIPRead, self.Address, Frame.DeviceTRIP, theCROCXChannelX, dw='D16', useBLT32=True)
    def TRIPWrite(self, theCROCXChannelX, theRegs, theTRIPIndex=None, theType='CROC'):
        if theTRIPIndex!=None:
            sentMessageHeader = Frame().MakeHeader(Frame.DirectionM2S, Frame.BroadcastNone, self.Address,
                Frame.DeviceTRIP, Frame.FuncTRIPWRi[theTRIPIndex])
        else:sentMessageHeader = Frame().MakeHeader(Frame.DirectionM2S, Frame.BroadcastNone, self.Address,
        ...
        sentMessage = sentMessageHeader + sentMessageData
        if theType=='CROC':
            WriteSendReceive(sentMessage, Frame.MessageDataLengthTRIPWrite, self.Address, Frame.DeviceTRIP, theCROCXChannelX, dw='D16', useBLT32=True)
        if theType=='CROCE':
            WriteSendReceiveCROCE(sentMessage, Frame.MessageDataLengthTRIPWrite, self.Address, Frame.DeviceTRIP, theCROCXChannelX, dw='D16', useBLT32=True)
    def FLASHMainMemPageRead(self, theCROCXChannelX, pageAddr, theType='CROC'):
        sentMessageHeader = Frame().MakeHeader(Frame.DirectionM2S, Frame.BroadcastNone, self.Address,
        ...
        if theType=='CROC':
            rcvMessageData,rcvMFH_10bytes=WriteSendReceive(sentMessage, Frame.MessageDataLengthFLASHMMPRead, self.Address, Frame.DeviceFLASH, theCROCXChannelX, dw='D16', useBLT32=True)
        if theType=='CROCE':
            rcvMessageData,rcvMFH_10bytes=WriteSendReceiveCROCE(sentMessage, Frame.MessageDataLengthFLASHMMPRead, self.Address, Frame.DeviceFLASH, theCROCXChannelX, dw='D16', useBLT32=True)
        return rcvMessageData[len(sentMessageDataOpCode):len(sentMessageDataOpCode)+Flash.NBytesPerPage]
    def FLASHMainMemPageProgThroughBuffer(self, theCROCXChannelX, pageAddr, pageBytes, bufferIndex=1, theType='CROC'):
        sentMessageHeader = Frame().MakeHeader(Frame.DirectionM2S, Frame.BroadcastNone, self.Address,
            Frame.DeviceFLASH, Frame.FuncFLASHCommand)
        ...
        if theType=='CROC':
            WriteSendReceive(sentMessage, Frame.MessageDataLengthFLASHMMPPTB, self.Address, Frame.DeviceFLASH, theCROCXChannelX, appendData=pageBytes[0], dw='D16', useBLT32=True)
        if theType=='CROCE':   
            WriteSendReceiveCROCE(sentMessage, Frame.MessageDataLengthFLASHMMPPTB, self.Address, Frame.DeviceFLASH, theCROCXChannelX, appendData=pageBytes[0], dw='D16', useBLT32=True)
        sentMessage = sentMessageHeader + [Flash.OpStatRegRead] + 8*[0]
        if theType=='CROC':
            for i in range(100):
                rcvMessageData, rcvMFH_10bytes = WriteSendReceive(sentMessage, 9, self.Address, Frame.DeviceFLASH, theCROCXChannelX)
                #print 'i=%d, rcvMFH_10bytes=%s, rcvMessageData=%s'%(i, rcvMFH_10bytes, rcvMessageData) 
                if rcvMessageData[8]&0x80==0x80: break
        if theType=='CROCE':
            for i in range(100):
                rcvMessageData, rcvMFH_10bytes = WriteSendReceiveCROCE(sentMessage, 9, self.Address, Frame.DeviceFLASH, theCROCXChannelX)
                #print 'i=%d, rcvMFH_10bytes=%s, rcvMessageData=%s'%(i, rcvMFH_10bytes, rcvMessageData)
                if rcvMessageData[8]&0x80==0x80: break       
        if i==100: raise Exception('MainMemPageProgThroughBuffer StatusBit NOT Ready')
    def WriteFileToFlash(self, theCROCXChannelX=None, theCROCX=None, theVMECROCXs=None,
            toThisFEB=False, toThisCHX=False, toThisCROCX=False, toAllCROCXs=False, theFrame=None, theType=None):
        ...
        if dlg.ShowModal()==wx.ID_OK:
            ...
            f.close()
            if toThisFEB:
                self.WritePagesToFlash(self, theCROCXChannelX, theCROCX, pagesAddrFile, pagesBytesFile, theFrame, theType)     
            if toThisCHX:
                for febAddress in theCROCXChannelX.FEBs:
                    theFEB=FEB(febAddress)
                    self.WritePagesToFlash(theFEB, theCROCXChannelX, theCROCX, pagesAddrFile, pagesBytesFile, theFrame, theType)
            if toThisCROCX:
                ...
                for theCROCX in theVMECROCXs:
                    for theCROCXChannelX in theCROCX.Channels():
                        for febAddress in theCROCXChannelX.FEBs:
                            ...
                            self.WritePagesToFlash(theFEB, theCROCXChannelX, theCROCX, pagesAddrFile, pagesBytesFile, theFrame, theType)
        dlg.Destroy()
    def WritePagesToFlash(self, theFEB, theCROCXChannelX, theCROCX, pagesAddrFile, pagesBytesFile, theFrame, theType):
        errPages=''
        ...
        for iPage in range(Flash.NPages):
            theFEB.FLASHMainMemPageProgThroughBuffer(theCROCXChannelX, pagesAddrFile[iPage], pagesBytesFile[iPage], bufferIndex=1, theType=theType)
    ...
    def AlignGateDelays(self, theCROCX, theCROCXChannelX, theNumberOfMeas, theLoadTimerValue, theGateStartValue, theType='CROC'):
        ...
        print 'Reporting FEBs TPDelay measurements on %s %s'%(theCROCX.Description(),theCROCXChannelX.Description())
        ...
        for febAddress in theCROCXChannelX.FEBs:
            ...
            theFEB.FPGAWrite(theCROCXChannelX, rcvMessageData, theType)
            rcvMessageData,rcvMFH_10bytes=theFEB.FPGARead(theCROCXChannelX, theType)
        #Enable TP
        if theType=='CROC':
    ...
    def GetAllHVParams(self, vmeCROCXs, theType='CROC', devVal=0):
        ...
        for theCROCX in vmeCROCXs:
            for theCROCXChannelX in theCROCX.Channels():
                for febAddress in theCROCXChannelX.FEBs:
                    theFEB=FEB(febAddress)
                    rcvMessage,rcvMFH_10bytes=theFEB.FPGARead(theCROCXChannelX, theType)
                    ...
                    if abs(hvActual-hvTarget)>=devVal:
                        if theType=='CROC': descr={'FEB':febAddress, 'Channel':theCROCXChannelX.chNumber, 'CROC':theCROCX.baseAddr>>16}
                        if theType=='CROCE': descr={'FEB':febAddress, 'Channel':theCROCXChannelX.cheNumber, 'CROCE':theCROCX.baseAddr>>24}
        ...
        for theCROCX in vmeCROCXs:
            for theCROCXChannelX in theCROCX.Channels():
                for febAddress in theCROCXChannelX.FEBs:
                    ...
                    theFEB.FPGAWrite(theCROCXChannelX, rcvMessage, theType)
    ...
    def ParseMessageToTRIPRegsPhysical(self, msg, theTRIPIndex):
        ...
        return pRegs
    def DecodeBRAMDiscrims(self, rcvDataBytes, source):
    ...
    def DecodeBRAMTrips(self, rcvDataBytes, source, itrip):
        ...
        return triphits
    def DecodeBRAMHits(self, rcvDataBytes, source, ihit):
        ...
        #    #2bytes*36channels*6trips=432+0dummy=432==Frame.MessageDataLengthBRAMHitRead, actually is 431 due to an error in the VHDL code...
        #    raise Exception('DecodeBRAMHits: Error expecting %d data words, received %d'%(Frame.MessageDataLengthBRAMHitRead, len(rcvDataBytes)))
        rcvDataBytes.extend([0,0])
        hittrips=[[],[],[],[],[],[]]
        indx=1
...
class Frame():
    ...
    NTRIPs=6
    MessageHeaderLength=9                   #FRED=8+start=9
    MessageDataLengthFPGA=55                #FRED=54+dummy=55
    ...
    MessageDataLengthBRAMTripRead=578       #FRED=2bytes*36channels*8hits=576+dummy=577
...
##    MessageDataLengthBRAMDiscrimRead=1281   #FRED=2bytes*20records*8hits*4trips=1280+dummy=1281
    ...
    def GetReceivedHeaderErrors(self, header, direction, broadcast, febAddress, device, frameID0=0, frameID1=0):
        ...
        return err
def WriteSendReceive(sentMessage, rcvMessageLength, theFEBAddress, theFEBDevice, theCROCChannel, appendData=0, dw='D16', useBLT32=False):
...
def WriteSendReceiveCROCE(sentMessage, rcvMessageLength, theFEBAddress, theFEBDevice, theCROCEChannelE, appendData=0, dw='D16', useBLT32=False):
    ClearAndCheckStatusRegisterCROCE(theCROCEChannelE)
    WriteFIFOAndCheckStatusCROCE(sentMessage, theCROCEChannelE, appendData)
    SendFIFOAndCheckStatusCROCE(theCROCEChannelE)
    if useBLT32: rcvMFH_10bytes,rcvMessageHeader,rcvMessageData=GetRcvMessageHeaderAndDataBLTCROCE(theCROCEChannelE)
    else: rcvMFH_10bytes,rcvMessageHeader,rcvMessageData=GetRcvMessageHeaderAndDataCROCE(theCROCEChannelE,dw)
    #print 'length=%s, sentMessage     =%s'%(str(len(sentMessage)).rjust(3,'0'),[hex(x)[2:].rjust(2,'0') for x in sentMessage])
    #print 'length=%s, rcvMFH_10bytes  =%s'%(str(len(rcvMFH_10bytes)).rjust(3,'0'),[hex(x)[2:].rjust(2,'0') for x in rcvMFH_10bytes])
    #print 'length=%s, rcvMessageHeader=%s'%(str(len(rcvMessageHeader)).rjust(3,'0'),[hex(x)[2:].rjust(2,'0') for x in rcvMessageHeader])
    #print 'length=%s, rcvMessageData  =%s'%(str(len(rcvMessageData)).rjust(3,'0'),[hex(x)[2:].rjust(2,'0') for x in rcvMessageData])
    rcvHeaderErr=Frame().GetReceivedHeaderErrors(rcvMessageHeader,
        Frame.DirectionS2M, Frame.BroadcastNone, theFEBAddress, theFEBDevice)
    if len(rcvHeaderErr)!=0: raise Exception(rcvHeaderErr)
    if rcvMessageLength!=0 and len(rcvMessageData)!=rcvMessageLength: raise Exception(
...
def ClearAndCheckStatusRegisterCROCE(theCROCEChannelE, chk=True):
    config=theCROCEChannelE.ReadConfiguration()
    if (config&0xC000!=0x0000): theCROCEChannelE.WriteConfiguration(config&0x003F)
    ...
    if chk:
        ...
        if data[2:6]!=[0x0000,0x4040,0x2410,0x0000]: raise Exception(
            '%s: ClearAndCheckStatusRegisterCROCE Error ReadAllRegisters=%s, should be [0xXXXX,0xXXXX,0x0000,0x4040,0x2410,0x0000,0xXXXX]'\
            %(theCROCEChannelE.Description(),['0x'+hex(d)[2:].rjust(4,'0') for d in data]))
...
def WriteFIFOAndCheckStatusCROCE(theMessage, theCROCEChannelE, appendData=0, chk=True):
    if len(theMessage)%2==1: theMessage.append(appendData)
    for i in range(0,len(theMessage),2):
        data = (theMessage[i]<<8) + theMessage[i+1]
    ...
    if chk:
        ...
        if data[2:6]!=[0x0000,0x0040,0x2410,0x0000]: raise Exception(
            '%s: WriteFIFOAndCheckStatusCROCE Error ReadAllRegisters=%s, should be [0xXXXX,0xXXXX,0x0000,0x0040,0x2410,0x0000,0xXXXX]'\
            %(theCROCEChannelE.Description(),['0x'+hex(d)[2:].rjust(4,'0') for d in data]))
...
def SendFIFOAndCheckStatusCROCE(theCROCEChannelE, chk=True):
    ...
    if (data[2:5]!=[0x0001,0x1010,0x2410]): raise Exception(
        '%s: Error ReadAllRegisters=%s, should be [0x00XX,0xXXXX,0x0001,0x1010,0x2410,0xXXXX,0xXXXX]'\
        %(theCROCEChannelE.Description(),['0x'+hex(d)[2:].rjust(4,'0') for d in data]))
...
def GetRcvMessageHeaderAndDataCROCE(theCROCEChannelE,dw='D16'):
    ...
    rcvMessageData=[]
    if dw=='D16':
        for i in range(0, RcvMemWPointerRegister, 2):
            data=theCROCEChannelE.ReadReceiveMemory(i)
            rcvMessage.append((data&0xFF00)>>8)
            rcvMessage.append(data&0x00FF)
        rcvMessageLength=(rcvMessage[0]<<8)+rcvMessage[1]
        rcvMessageStatus=(rcvMessage[2]<<8)+rcvMessage[3]
    if dw=='D32':
        if RcvMemWPointerRegister%4==0: rcvmemwpointer=RcvMemWPointerRegister
        else: rcvmemwpointer=RcvMemWPointerRegister + (4-RcvMemWPointerRegister%4)
        for i in range(0, rcvmemwpointer, 4):
            data=theCROCEChannelE.ReadReceiveMemory(i,'D32')
        ...
        rcvMessageLength=(rcvMessage[0]<<8)+rcvMessage[1]
        rcvMessageStatus=(rcvMessage[2]<<8)+rcvMessage[3]
    #print 'inside SC_MainObjects: GetRcvMessageHeaderAndDataCROCE: RcvMemWPointerRegister=%s, RcvMemMessageLength=%s, RcvMemMessageStatus=%s'%(RcvMemWPointerRegister,rcvMessageLength,hex(rcvMessageStatus))
    #print 'CROCE    : rcvMessage      =%s, %s'%(''.join([hex(x)[2:].rjust(2,'0') for x in rcvMessage]),len(rcvMessage))
    if rcvMessageLength!=RcvMemWPointerRegister: raise Exception(
        '%s: Error RcvMemWPointerRegister=%s <> RcvMemMessageLength=%s'\
    ...
    if rcvMessageLength<(10+Frame.MessageHeaderLength): raise Exception(
        '%s: Error RcvMemMessageLength=%s < 10 + %s (message too short)'\
    ...
    if rcvMessageStatus!=StatusFrameRegister: raise Exception(
        '%s: Error RcvMemFrameStatusRegister=%s <> RcvMemMessageStatus=%s'\
    ...
    if rcvMessageLength>19: rcvMessageData=rcvMessage[19:rcvMessageLength]
    #print 'CROCE    : rcvMessageHeader=%s, %s'%(''.join([hex(x)[2:].rjust(2,'0') for x in rcvMessageHeader]),len(rcvMessageHeader))
    #print 'CROCE    : rcvMessageData  =%s, %s'%(''.join([hex(x)[2:].rjust(2,'0') for x in rcvMessageData]),len(rcvMessageData))
    return (rcvMFH_10bytes,rcvMessageHeader, rcvMessageData)
def GetRcvMessageHeaderAndDataBLT(theCROCChannel):
    ...
    rcvMessageHeader=rcvMessage[2:11]
    if rcvLength>11: rcvMessageData=rcvMessage[11:rcvLength]
    #print 'CROC BLT : rcvMessage      =%s, %s'%(''.join([hex(x)[2:].rjust(2,'0') for x in rcvMessage]),len(rcvMessage))
    ...
    return (rcvMessageHeader, rcvMessageData)
def GetRcvMessageHeaderAndDataBLTCROCE(theCROCEChannelE):
...
class WorkerThreadCROCE(threading.Thread):
    def __init__(self,threadNumber,window,nEvents,CROCE,CROCEChannelE,CROCEs,ReadType):
    ...
    def run(self):
        ...
        for iEvent in range(self.nEvents):
            ...
            elif self.ReadType==3:                                          # RO all CROCEs
            ...
            if self.ReadType==0 or self.ReadType==1:                        # RO one FEB or RO one CH
                rcvmem.append(['%s:%s'%(self.CROCE.Description(), self.CROCEChannelE.Description()), self.CROCEChannelE.ReadFullDPMBLT()])
                ...
                for ich in range(4):
                    rcvmem.append(['%s:%s'%(self.CROCE.Description(), self.CROCE.Channels()[ich].Description()), self.CROCE.Channels()[ich].ReadFullDPMBLT()])
                ...
                for croce in self.CROCEs:
                    for ich in range(4):
                        rcvmem.append(['%s:%s'%(croce.Description(), croce.Channels()[ich].Description()), croce.Channels()[ich].ReadFullDPMBLT()])
            ...
            ##SC_MainMethods.DAQReadRcvMemReportFrames(iEvent, frms, self.WriteType, self.WFile, None, 'CROCE')
