 ...
 *
 * $Id: SerialStreamBuf.h,v 1.1 2010/01/08 03:36:13 jwolcott Exp $
 *
 *
 */
...
extern "C++" {
    namespace LibSerial {
         ...
         *
         * @author $Author: jwolcott $ <A HREF="pagey@gnudom.org">Manish P. Pagey</A>
         * @version $Id: SerialStreamBuf.h,v 1.1 2010/01/08 03:36:13 jwolcott Exp $
         * */
