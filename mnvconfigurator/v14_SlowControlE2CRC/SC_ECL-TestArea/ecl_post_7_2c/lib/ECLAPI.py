...
class ECLEntry:
    ...
    def setValue(self, name, value,tagvalue=""):
        # Create the field
        if tagvalue !="":
            field = etree.SubElement(self._form, 'field', name=name,value=tagvalue)
        else:
    ...
    def addEntryComment(self, text):
        self._entry.attrib['entry_comment'] = text
