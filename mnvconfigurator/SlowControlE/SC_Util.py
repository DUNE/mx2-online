...
class CROCECHERegs():
    ...
    RegRDFECounter          = 0x028008
    RegTXRstTpInDelayCounter= 0x028010
    RegRRcvMemFramesCounter = 0x028010
    RegStatusFrame          = 0x028020
    RegStatusTXRX           = 0x028040
    RegRcvMemWPointer       = 0x028080
...
def CROCECHEStatusFrameRegLabelsData():
    ...
    leftLabels=(
        ...
        (' RcvMem_FrmDiscType', pos, size, '', color),)
    rightLabels=(('X', pos, (10, 16), '', 'white'),)
    rightLabels=(len(leftLabels))*rightLabels
    return (leftLabels, rightLabels)
...
class BoardTest():
 def __init__(self, panel, caption=' CROCE Board Test', testcaptions=['RUN BOARD TEST', 'T1','T2','T3','T4','T5','T6','T7'],
        ...
        lblNtimes=CreateLabel(panel, 'N times', pos=(0,0), size=(60, 20), name='', color=colorLabel)
        self.txtNtimes=CreateTextCtrl(panel, label='1', pos=(0,0), size=(70, 20), name='', bckcolor=colorText)
        ...
        lblRAMData=CreateLabel(panel, 'RAM data', pos=(0,0), size=(60, 20), name='', color=colorLabel)
        self.txtRAMData=CreateTextCtrl(panel, label='FFFF', pos=(0,0), size=(70, 20), name='', bckcolor=colorText)
        ...
        szH2.Add(lblRAMData, 0, wx.ALL, 4)
...
class VMEReadWrite():
    def __init__(self, panel, caption=' VME Read/Write (hex)'):
        ...
        sz.Add(self.choiceAddressModifier, 0, 0, 0)
        sz.Add(self.choiceDataWidth, 0, 0, 0)
        sz.Add(self.txtBLTSize, 0, 0, 0)
        self.BoxSizer=wx.StaticBoxSizer(StaticBox, wx.VERTICAL)
...
class CHECommandsRegister():
    def __init__(self, panel, caption=' Commands'):
        ...
        self.controls=[StaticBox, self.btnWrite, 
            ...
            self.chkClearRcvMemWPointer, self.chkClearRDFECounter, self.chkTXSendSyncWords]
    def ResetControls(self):
