 ...
 */
  ...
  //It's never clear to me whether or not these ever get a value, but they don't
  //ever seem to need one
}

void Frames::MakeDeviceFrameTransmit(Devices dev,Broadcasts b, Directions d, unsigned int f, unsigned int feb) {
  /*! \fn********************************************************************************
 ...
 *********************************************************************************/
  ...
  frameHeader[0] = (messageDirection[0] & 0x80 ); //The direction bit is in bit 7 of 
                                                         //word 1
...
void Frames::MakeMessage() { std::cout<<"Hi Elaine!"<<std::endl;} //each class which inherits frames makes its own messages
