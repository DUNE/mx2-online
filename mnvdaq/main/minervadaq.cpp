...
/*! The main routine which executes the data acquisition sequences
    for minervadaq. */
...
/*********************************************************************************/
  ...
  if (argc!=3) {
    cout<<"You forgot to give me the number of gates you want recorded! "<<endl;
    cout<<"No matter how hard I try, I can't record any data if you don't tell me"<<endl;
    cout<<"how many gates you want!"<<endl;
...
/**********************************************************************************/
      ...
      //Get Trigger Time, Error, MINOS (whatever error & MINOS are)
