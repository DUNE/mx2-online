...
/* Exit codes used by minervadaq. */
const int EXIT_CLEAN_SENTINEL    =  0;	/*!< Clean exit.  Sentinel frame is coming from this node. */
const int EXIT_CLEAN_NOSENTINEL  =  1;  /*!< Clean exit.  NO sentinel is coming from this node. */
const int EXIT_UNSPECIFIED_ERROR = -1;  /*!< Unclean exit with an otherwise unspecified error.  More information might be generated by a STDOUT dump or logfile write immediately preceding this exit. */
