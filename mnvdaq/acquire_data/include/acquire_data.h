...
#include "controller.h" //I may have been more clever than I thought
#include "adctdc.h" //this class isn't included in the contoller classes
#include "acquire.h" //we need access to the reads & writes
